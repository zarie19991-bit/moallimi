...
$('startForm').addEventListener('submit',async e=>{
 ...
 localStorage.setItem('nafes_student',JSON.stringify({name,no}));
 const btn=$('startBtn')||e.submitter;btn.disabled=true;btn.textContent='جارٍ تجهيز نموذجك...';
 try{
  const d=await call({action:'start',student_name:name,student_no:no,national_id_last3:no});
