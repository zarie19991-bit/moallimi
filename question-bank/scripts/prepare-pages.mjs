...
for(const file of ['index.html','teacher.html','student-demo.html','create.html','analysis.html','student-papers.html','e.html','exam.html','simulation.html','question-media.js']){
