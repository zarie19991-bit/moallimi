...
function item(r,q,correct,wrong,explanation='',context=null,level='application'){
 const correctText=typeof correct==='number'?fmt(correct):String(correct),distractors=[];
 const add=v=>{const t=typeof v==='number'?fmt(v):String(v);if(t!==correctText&&!distractors.includes(t))distractors.push(t)};
 wrong.forEach(add);
...
function mathQuestion(t,r,n){
 ...
 case'factor_group':{const a=ri(r,2,6),b=ri(r,2,6);return item(r,`حلّل بالتجميع: أ س+أ ${b}+${a}س+${a*b}`,`(أ+${a})(س+${b})`,[`(أ+س)(${a}+${b})`,`(أ+${b})(س+${a})`,`أ(س+${b})+${a}`],'نجمع كل حدين ونستخرج العامل المشترك المتكرر.');}
